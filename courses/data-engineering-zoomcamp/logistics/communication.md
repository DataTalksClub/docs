...
The [DataTalks.Club Slack](https://datatalks.club/slack) is where the community interacts and where to get help.

Getting Started:

1. Join the [DataTalks.Club Slack](https://datatalks.club/slack)
...
Join the [Data Engineering Zoomcamp Telegram channel](https://t.me/dezoomcamp) for course announcements and updates only.
...
<img src="{{ '/assets/images/data-engineering-zoomcamp/automator-repost.png' | relative_url }}" alt="Au-Tomator bot reposting Telegram messages to Slack" width="80%">
